(function() {
    var quotes = [
        ...
        ['Eight years of C++Now attendance has helped me acquire next-level C++ skills, as well as a network of talented and influential fellow developers. The talks and environment are of the very highest quality. It\'s a transformative experience every time', 'Jeff Trull', 'C++ Consultant'],
    ];
